            ...
            <div className="padding-container max-container w-full pb-24">
                ...
                <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
                    ...
                    <p className="regular-16 text-gray-30 xl:max-w-[520px]">
                        With the Hilink application, you will never get lost again. We now support offline maps for when there is no internet connection in the field. Invite your friends and relatives
